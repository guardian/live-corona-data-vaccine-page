...
# 	print("currentdate", current_date)
	...
	if (ninety_vax_to_go < 0):
		...
		# print("ninety_finish_first", ninety_finish_first)	
	...
	# print("eighty_vax_to_go_second", eighty_vax_to_go_second, "seventy_vax_to_go_second", seventy_vax_to_go_second, "ninety_vax_to_go_second", ninety_vax_to_go_second)
...
# 	print("eighty_finish_second",eighty_finish_second)
	# print("ninety_finish_second",ninety_finish_second)
...
# 	print(eighty_vax_to_go_second,days_to_go_80,current_lag)
	...
	if days_to_second_90 == 0:
		ninety_second_doses_needed = 0
	else:
		ninety_second_doses_needed = int(round(ninety_vax_to_go_second / days_to_second_90,0))



    ## Add ninety target

	results = {"current_lag":current_lag, "eighty_finish_first": eighty_finish_first,
     "seventy_finish_first":seventy_finish_first, "eighty_finish_second":eighty_finish_second,
      "seventy_finish_second":seventy_finish_second, "current_rolling":current_rolling,
      "second_doses_rate_needed":second_doses_rate_needed,"eighty_target":eighty_target,
       "seventy_target":seventy_target, "seventy_reached":seventy_reached,
        "eighty_reached":eighty_reached,
		"ninety_finish_first": ninety_finish_first,
		"ninety_finish_second":ninety_finish_second,
		"ninety_target":ninety_target,
		"ninety_reached":ninety_reached, 'ninety_second_doses_needed': ninety_second_doses_needed}
	...
	if state == "QLD":
		...
		print("ninety_finish_first", ninety_finish_first)
		print("ninety_finish_second",ninety_finish_second)
		# print("days to go 90", days_to_second_90)
		# print("ninety_vax_to_go",ninety_vax_to_go)
		# print("eighty_finish_second",eighty_finish_second)
		# print(results)
# 	print(results)
	return results
		 ...
		 "seventy_finish_second":results["seventy_finish_second"].strftime("%Y-%m-%d"),"current_rolling":results['current_rolling'],
		  "second_doses_rate_needed":results['second_doses_rate_needed'], "eighty_target":results['eighty_target'],
		   "seventy_target":results['seventy_target'], "cutoff":cutoff_date, "seventy_reached": results['seventy_reached'],
			...
			"ninety_target":results['ninety_target'],"ninety_reached": results['ninety_reached'], 'ninety_second_doses_needed':results['ninety_second_doses_needed']}
