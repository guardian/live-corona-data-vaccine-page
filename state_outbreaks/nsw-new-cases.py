    ...
    template = [
            {
                ...
                "footnote": "",
                "source": "| * 12 January case numbers includes a backlog of RAT tests reported for the first time. Sources: NSW Health, covid19data, Guardian Australia, CovidLive.com.au",
                "dateFormat": "%Y-%m-%d",
                "xAxisDateFormat":"%b %d",
                "minY": "0",
                "maxY": "",
