	...
	template = [
			{
				...
				"subtitle": "Showing the seven-day rolling average in Covid vaccination doses administered daily per 1,000 people in each state and territory, versus the national rate. Showing the last 30 days only. Figures have been adjusted to average out the difference of the data changing sources on 16 August, see notes. Last updated {date}".format(date=updatedText),
				"footnote": "",
