...
# testo = "-testo"
testo = ''
chart_key = f"oz-datablogs-covid-page-juri-hospitalisation-selector-weekly{testo}"
...
def makeTestingLine(df):
    ...
    template = [
            {
                "title": "Weekly Covid hospitalisations by jurisdiction",
                "subtitle": f"""Showing the total number of Covid patients admitted to hospital on each Friday by jurisdiction. Gaps in the data have been interpolated. Some states have at times mandated that all Covid positive patients be admitted to hospital. Last updated {display_date}.""",
                "footnote": "",
